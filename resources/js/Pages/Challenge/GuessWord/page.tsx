        ...
        >
            {instructionIndex < instructions.length ? (
                ...
                <>
                    ...
                    {/* Timer Display */}
                    <div className="fixed top-[180px] sm:top-[200px] md:top-[200px] left-1/2 transform -translate-x-1/2 lg:top-[140px] lg:right-[433px] lg:left-auto lg:transform-none flex flex-col items-center gap-[30px] z-50">
