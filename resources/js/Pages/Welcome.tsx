        ...
        <>
            ...
            <div className={`min-h-screen bg-white font-sans ${showLoginModal ? 'blur-sm pointer-events-none select-none' : ''}`}>
                ...
                <div
                    ...
                    style={{ background: "url('/Img/LandingPage/Header_BG.png') left top / cover no-repeat" }}
                >
                    <div className="z-10 w-full md:flex-1 flex flex-col items-center md:items-start justify-center max-w-lg mx-auto md:mx-0 md:pl-10">
                        <div className="mt-10 md:mt-0 md:absolute md:left-10 md:top-10">
                            <img 
                        ...
                        <p 
                            className="mt-4 md:absolute md:top-[140px] lg:top-[180px] md:left-10 font-['Inter'] font-medium text-base md:text-lg lg:text-[22px] leading-7 lg:leading-[36px] text-[#282725] md:mt-8 md:ml-2 mb-0 max-w-2xl text-center md:text-left"
                            style={{ 
                                textShadow: '0px 4px 4px rgba(0,0,0,0.25)'
                            }}
                        >
                            Igniting Minds with Rizal's Legacy! Your ultimate game-based hub for mastering Noli Me Tangere, crafted to inspire and engage young learners.
                        </p>
                        <div className="mt-8 md:absolute md:left-10 lg:left-[350px] md:top-[280px] lg:top-[365px] flex items-center md:mt-10 mb-0 md:ml-2">
                            <button
                                className="w-[280px] md:w-[300px] lg:w-[340px] h-[70px] md:h-[80px] lg:h-[90px] bg-orange-500 hover:bg-orange-600 text-white text-2xl md:text-3xl lg:text-4xl font-extrabold rounded-[60px] border-4 md:border-[6px] lg:border-[8px] border-[#C97B3A] flex items-center justify-center"
                                style={{
                ...
                {/* Learn Section */}
                <section className="bg-[#F4F2EC] py-8 md:py-12 text-center px-4 border-t-[1px] border-b-[1px] border-[#282725]">
                    <div className="flex flex-col md:flex-row justify-around items-center">
                        
                        {/* Image hidden on mobile, shown on md+ */}
                        <div className="mb-6 md:mb-0 flex md:block hidden md:flex">
                        <img 
                        ...
                        <div className="w-full md:w-auto lg:w-[800px] flex flex-col justify-around items-center md:items-end gap-4">
                        <h2 
                ...
                {/* About Section */}
                <section className="px-4 md:px-6 py-8 md:py-12 bg-white text-center border-b-[1px] border-[#282725]">
                    <div className='flex flex-col md:flex-row items-center justify-around'>
                        <div className='h-auto flex gap-3 flex-col order-2 md:order-1 mb-6 md:mb-0'>
                            <h2 
                         ...
                         <div className="order-1 md:order-2">
                            <img src="/Img/LandingPage/design1.png" alt=""  className='h-[250px] md:h-[350px] lg:h-[400px]'/>
                        </div>
                   </div>
                </section>

                {/* Characters Section */}
                <section className="bg-gray-50 py-8 md:py-12 px-4 text-center border-b-[1px] border-[#282725]">
                    <h2 className="font-['Inter'] not-italic font-extrabold text-3xl md:text-4xl lg:text-[45px] leading-[1.2] md:leading-[1.3] lg:leading-[69px] mb-6 md:mb-10"
                        style={{
                            color: '#249EA0',
                            textShadow: '-2px 3px 0px #282725'
                        }}
                    ...
                    <div className="hidden lg:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 xl:gap-10 max-w-6xl mx-auto">
                        <CharacterCard
                    ...
                    <div className="lg:hidden relative overflow-hidden max-w-2xl md:max-w-3xl mx-auto">
                        <div
                ...
                <section style={{boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)'}} className='py-5 px-4'>
                    <div className='flex flex-row justify-between items-center gap-5'>
                        <div className="md:order-1">
                            <img src="/Img/LandingPage/square2.png" alt="" className="h-[300px] md:h-[400px] lg:h-[500px]"/>
                        </div>
                        <div className='flex flex-col items-center justify-center gap-4 order-1 md:order-2 mb-6 md:mb-0'>
                           <img src="/Img/LandingPage/jose.png" alt="" className="h-[150px] md:h-[200px] lg:h-[230px]" />
                        ...
                        <div className="order-3">
                            <img src="/Img/LandingPage/square3.png" alt="" className="h-[200px] md:h-[250px] lg:h-[300px]" />
                        </div>
                    </div>
                </section>
                ...
                <footer className="py-6 text-center px-4">
                    <div className="flex justify-center mt-4">
                        <img src="/Img/LandingPage/fchar.png" alt="Footer Characters" className="h-auto w-full max-w-4xl" />
                    </div>
                    <p className="mt-2 text-[#282725] font-['Inter'] font-medium text-base md:text-lg lg:text-[22px]">© 2025 RizHub. All rights reserved.</p>
                </footer>
            </div>
            <LoginModal 
                open={showLoginModal} 
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm p-4">
            <div className="w-full max-w-md mx-auto">
                <div className="fixed top-4 right-4 md:top-8 md:right-12 z-50 flex">
                    <button
                        className={`absolute px-6 py-3 md:px-12 md:py-4 rounded-full font-extrabold text-lg md:text-xl lg:text-2xl transition-all duration-200 focus:outline-none
                            ${isLogin
                    ...
                    <button
                        className={`px-6 py-3 md:px-12 md:py-4 rounded-full font-extrabold text-lg md:text-xl lg:text-2xl transition-all duration-200 focus:outline-none
                            ${!isLogin
                                ? 'bg-[#E26F42] text-white z-[100]'
                                : 'bg-[#5A3416] text-white'
                            }
                ...
                <div className="bg-[#FA7816] rounded-2xl shadow-2xl p-4 md:p-6 w-full relative flex flex-col items-center">
                    <button
                        className="absolute top-2 left-3 md:top-3 md:left-4 text-white text-xl hover:text-[#5A3416] font-bold"
                        onClick={handleClose}
                        aria-label="Close"
                    >✕</button>
